...
- Trusted raw inventory: `configs/raw_tdms_inventory.csv` (144 files, source `~/Documents/NDT-data`).
- Sensor counts: Differential 36, HallAirCore 36, HallPotCore 36, TMR 36.
- 127 complete, 17 short (all short by 1 scan point).
...
- Error TDMS replacements from `ERR Bo sung` were applied to `~/Documents/NDT-data`; replaced originals are archived under `~/Documents/NDT-data-archived/replaced-errors`.
